...
Revision ID: c3b1ab7d2f39
Revises: 
Create Date: 2024-01-17 17:49:45.357708
...
def upgrade() -> None:
    ...
    op.create_table('games_aggregated_by_hero',
                    ...
                    sa.ForeignKeyConstraint(['window_stats_id'], ['games_performance.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('player_games_data',
                    ...
                    sa.ForeignKeyConstraint(['game_id'], ['games.id'], ),
                    sa.ForeignKeyConstraint(['hero_id'], ['heroes.id'], ),
                    sa.ForeignKeyConstraint(['performance_id'], ['games_performance.id'], ),
                    sa.ForeignKeyConstraint(['player_id'], ['players.id'], ),
                    sa.ForeignKeyConstraint(['position_id'], ['positions.id'], ),
