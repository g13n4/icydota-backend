...
Revision ID: ce44ca879dc2
Revises: 59018b3b2698
Create Date: 2024-02-20 00:54:24.287826
...
revision: str = 'ce44ca879dc2'
down_revision: Union[str, None] = '59018b3b2698'
...
PERFORMANCE_TOTALS_DATA.TOTAL_GOLD AS TOTAL_GOLD,
PERFORMANCE_TOTALS_DATA.TOTAL_XP AS TOTAL_XP,
PERFORMANCE_TOTALS_DATA.KILLS_PER_MIN AS KILLS_PER_MIN,
PERFORMANCE_TOTALS_DATA.KDA AS KDA,
PERFORMANCE_TOTALS_DATA.NEUTRAL_KILLS AS NEUTRAL_KILLS,
PERFORMANCE_TOTALS_DATA.TOWER_KILLS AS TOWER_KILLS,
PERFORMANCE_TOTALS_DATA.COURIER_KILLS AS COURIER_KILLS,
PERFORMANCE_TOTALS_DATA.LANE_KILLS AS LANE_KILLS,
PERFORMANCE_TOTALS_DATA.HERO_KILLS AS HERO_KILLS,
PERFORMANCE_TOTALS_DATA.OBSERVER_KILLS AS OBSERVER_KILLS,
PERFORMANCE_TOTALS_DATA.SENTRY_KILLS AS SENTRY_KILLS,
PERFORMANCE_TOTALS_DATA.ROSHAN_KILLS AS ROSHAN_KILLS,
PERFORMANCE_TOTALS_DATA.RUNES_PICKED_UP AS RUNES_PICKED_UP,
PERFORMANCE_TOTALS_DATA.ANCIENT_KILLS AS ANCIENT_KILLS,
PERFORMANCE_TOTALS_DATA.BUYBACK_COUNT AS BUYBACK_COUNT,
PERFORMANCE_TOTALS_DATA.OBSERVER_USES AS OBSERVER_USES,
PERFORMANCE_TOTALS_DATA.SENTRY_USES AS SENTRY_USES,
PERFORMANCE_TOTALS_DATA.LANE_EFFICIENCY AS LANE_EFFICIENCY,
PERFORMANCE_TOTALS_DATA.LANE_EFFICIENCY_PCT AS LANE_EFFICIENCY_PCT,
PERFORMANCE_TOTALS_DATA.FIRST_BLOOD_CLAIMED AS FIRST_BLOOD_CLAIMED,
PERFORMANCE_TOTALS_DATA.FIRST_KILL_TIME AS FIRST_KILL_TIME,
PERFORMANCE_TOTALS_DATA.DIED_FIRST AS DIED_FIRST,
PERFORMANCE_TOTALS_DATA.FIRST_DEATH_TIME AS FIRST_DEATH_TIME,
PERFORMANCE_TOTALS_DATA.LOST_TOWER_FIRST AS LOST_TOWER_FIRST,
PERFORMANCE_TOTALS_DATA.LOST_TOWER_LANE AS LOST_TOWER_LANE,
PERFORMANCE_TOTALS_DATA.FIRST_DEATH_TIME AS LOST_TOWER_TIME,
PERFORMANCE_TOTALS_DATA.DESTROYED_TOWER_FIRST AS DESTROYED_TOWER_FIRST,
PERFORMANCE_TOTALS_DATA.DESTROYED_TOWER_LANE AS DESTROYED_TOWER_LANE,
PERFORMANCE_TOTALS_DATA.DESTROYED_TOWER_TIME AS DESTROYED_TOWER_TIME
