...
ALL_DATA = ['interval|gold__max', 'interval|gold__gained_pm_median', 'interval|gold__gained_pw',
            'interval|gold__avg_(by_length)_pm', 'interval|gold__max_global_perc', 'interval|xp__max',
            'interval|xp__gained_pm_median', 'interval|xp__gained_pw', 'interval|xp__avg_(by_length)_pm',
            'interval|xp__max_global_perc', 'interval|lh__max', 'interval|lh__gained_pw',
            'interval|lh__avg_(by_length)_pm', 'interval|movement__sum', 'interval|movement__avg_(by_length)_pm',
            'interval|level__max', 'interval|level__gained_pw', 'interval|kills__max',
            'interval|kills__avg_(by_length)_pm', 'interval|kills__max_global_perc', 'interval|deaths__max',
            'interval|deaths__avg_(by_length)_pm', 'interval|deaths__max_global_perc', 'interval|kda__max',
            'interval|kda__avg_(by_length)_pm', 'interval|kda__gained_pw', 'interval|obs_placed__max',
            'interval|obs_placed__avg_(by_length)_pm', 'interval|sen_placed__max',
            'interval|sen_placed__avg_(by_length)_pm', 'interval|stacked__max', 'interval|stacked__avg_(by_length)_pm',
            'interval|rune_pickups__max', 'interval|teamfight_participation__avg',
            'interval|teamfight_participation__max', 'interval|teamfight_participation__min',
            'interval|towers_killed__max', 'interval|towers_killed__gained_pw', 'interval|roshans_killed__max',
            'interval|networth__max', 'interval|networth__gained_pw', 'pings|pings', 'pings|pings_per_minute',
            'wards|placed_wards_sen', 'wards|placed_wards_obs', 'wards|was_dewarded_sen', 'wards|was_dewarded_obs',
            'wards|was_dewarded_perc_sen', 'wards|was_dewarded_perc_obs', 'wards|killed_sen', 'wards|killed_obs',
            'wards|killed_sen_pm', 'wards|killed_obs_pm', 'damage|with_summons__sum', 'damage|with_summons__mean',
            'damage|with_summons__median', 'damage|with_summons__dmg_inst', 'damage|to_heroes__sum',
            'damage|to_heroes__mean', 'damage|to_heroes__median', 'damage|to_heroes__dmg_inst',
            'damage|to_buildings__sum', 'damage|to_buildings__mean', 'damage|to_buildings__median',
            'damage|to_buildings__dmg_inst', 'damage|to_creatures__sum', 'damage|to_creatures__mean',
            'damage|to_creatures__median', 'damage|to_creatures__dmg_inst', 'damage|to_illusions__sum',
            'damage|to_illusions__mean', 'damage|to_illusions__median', 'damage|to_illusions__dmg_inst',
            'damage|to_all__sum', 'damage|to_all__mean', 'damage|to_all__median', 'damage|to_all__dmg_inst',
            'damage|from_heroes__sum', 'damage|from_heroes__mean', 'damage|from_heroes__median',
            'damage|from_heroes__dmg_inst', 'damage|from_buildings__sum', 'damage|from_buildings__mean',
            'damage|from_buildings__median', 'damage|from_buildings__dmg_inst', 'damage|from_creatures__sum',
            'damage|from_creatures__mean', 'damage|from_creatures__median', 'damage|from_creatures__dmg_inst',
            'damage|from_illusions__sum', 'damage|from_illusions__mean', 'damage|from_illusions__median',
            'damage|from_illusions__dmg_inst', 'damage|from_all__sum', 'damage|from_all__mean',
            'damage|from_all__median', 'damage|from_all__dmg_inst', 'xp|other', 'xp|xp for heroes',
            'xp|xp for heroes pm', 'xp|xp for creeps', 'xp|xp for creeps pm', 'xp|xp for roshan', 'gold|death penalty',
            'gold|death penalty pm', 'gold|gold for assist', 'gold|gold for assist pm',
            'gold|gold for killing buildings', 'gold|gold for killing buildings pm', 'gold|gold for killing heroes',
            'gold|gold for killing heroes pm', 'gold|gold for killing creeps', 'gold|gold for killing creeps pm',
            'gold|gold for killing neutrals', 'gold|gold for killing neutrals pm', 'gold|gold for killing roshan',
            'gold|gold for killing roshan pm', 'gold|gold for assisting killing couriers',
            'gold|gold for assisting killing couriers pm', 'gold|gold runes', 'gold|gold runes pm',
            "gold|gold for flag bearer (and doom's devour)", "gold|gold for flag bearer (and doom's devour) pm",
            'gold|gold for wards', 'gold|gold for wards pm', 'gold|gold for killing couriers',
            'gold|gold for killing couriers pm']
