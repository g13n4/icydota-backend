...
def process_aggregation(league_id: int):
    logger.info(f'Aggregating windows_data for {league_id}')
    ...
    logger.info('Getting processing windows windows_data')
    ...
    logger.info('Getting processing windows comparison windows_data')
    ...
    logger.info('Getting processing totals windows_data')
    ...
    logger.info('Getting processing totals comparison windows_data')
    ...
    logger.info('Writing windows_data down')
